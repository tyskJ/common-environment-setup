...
- `.steering/20260103-initial-implementation/`
- `.steering/20260115-add-tag-feature/`
- `.steering/20260120-fix-filter-bug/`
- `.steering/20260201-improve-performance/`
...
```bash
mkdir -p .steering/20260115-add-tag-feature
```
